...
import { FollowupEffectSchema, PLANNED_CHANGE_ID_PATTERN } from "./planned-changes.ts";
...
export const PlannedChangeIdSchema = Type.String({
	...
	maxLength: 80,
	description: "Stable lowercase hyphen-separated change ID, not a display number",
});
...
export const ScopeEffectSchema = FollowupEffectSchema;
